...
"""Verify that starting atomd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start atomd with -h for help text")
        ...
        self.log.info("Start atomd with -version for version information")
        ...
        self.log.info("Start atomdd with -fakearg to make sure it does not start")
