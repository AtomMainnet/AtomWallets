...
"""Test the atom specific ZMQ notification interfaces."""
...
from test_framework.test_framework import AtomTestFramework
...
class AtomZMQTest (AtomTestFramework):
    def set_test_params(self):
        ...
        self.set_atom_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_atom_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that atomd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all atom related ZMQ publisher
