...
from test_framework.messages import atomhash, hash256
...
def atomhash_reversed(byte_str):
    return atomhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], atomhash_reversed(block[:80]).hex())
