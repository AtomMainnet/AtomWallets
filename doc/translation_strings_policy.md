...
This document provides guidelines for internationalization of the Atom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `atom_en.ts` remains unchanged.
