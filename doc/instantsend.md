...
This mechanism has been integrated into Bitcore-Node-Atom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/atompay/insight-api-atom#web-socket-api](https://github.com/atompay/insight-api-atom#web-socket-api)
* API: [https://github.com/atompay/insight-api-atom#instantsend-transactions](https://github.com/atompay/insight-api-atom#instantsend-transactions)
