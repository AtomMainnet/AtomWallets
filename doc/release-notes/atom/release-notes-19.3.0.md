...
- `wipetxes`: New command for `atom-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/AtomMainnet/compare/v19.2.0...atompay:v19.3.0).
