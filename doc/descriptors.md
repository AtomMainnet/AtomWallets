# Support for Output Descriptors in Atom Core

Since Atom Core v0.17, there is support for Output Descriptors. This is a
...
existing Atom Core wallets, a convenience function `combo` is
...
All RPCs in Atom Core will include the checksum in their output. Only
