...
//! Interface for the src/evo part of a atom node (atomd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a atom node (atomd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a atom node (atomd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a atom node (atomd process).
...
//! Top-level interface for a atom node (atomd process).
class Node
{
public:
    virtual ~Node() {}
