...
// Copyright (c) 2024 The Atom Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1722801384, nBits=1e0ffff0, nNonce=1242654, vtx=1)
...
{
    const char* pszTimestamp = "AtomCore 2024";
    const CScript genesisOutputScript = CScript() << ParseHex("04054653e33e2cc229f0138bd7cd51ad2ecc5f12d90d7da0d38cb8315d98f6cdabdeec2af05ace59865388e7eb8cf9a62568ee48f012280f9d4ef65a291216fc0d") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 66666; // spk tom
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 1; 
        consensus.nSuperblockStartHash = uint256();
        consensus.nSuperblockCycle = 66666; //spk tom
        ...
        consensus.defaultAssumeValid = uint256S("0x00000d72d4d3ae461ec3a498916254a581d19889240f8d77de11ed200edb4237"); 
        ...
        genesis = CreateGenesisBlock(1722801384, 1242654, 0x1e0ffff0, 1, 10 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000d72d4d3ae461ec3a498916254a581d19889240f8d77de11ed200edb4237"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad6e1bdb9520da07dcc11fe960afcb5fb025679b015af2c2265aedec7acb815"));
        ...
        vSeeds.emplace_back("194.58.114.162");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Atom BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Atom BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Atom BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"TNxQreuh9eSHHJdRrf6uKgtJ3uuWkxfskn"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000d72d4d3ae461ec3a498916254a581d19889240f8d77de11ed200edb4237")},
            }
        };
        ...
        // getchaintxstats 17280 00000d72d4d3ae461ec3a498916254a581d19889240f8d77de11ed200edb4237
        chainTxData = ChainTxData{
                1722801384, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000030285a2a68613656d384fbd96d2e18ba0387ce3191c137506fe34eb8aa3"); 
        ...
        genesis = CreateGenesisBlock(1722801389UL, 65414UL, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000030285a2a68613656d384fbd96d2e18ba0387ce3191c137506fe34eb8aa3"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad6e1bdb9520da07dcc11fe960afcb5fb025679b015af2c2265aedec7acb815"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Testnet Atom BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Atom BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Atom BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TAiUiiMKpFrjv7qa8U5GXEu6siCSrJEjv5"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000030285a2a68613656d384fbd96d2e18ba0387ce3191c137506fe34eb8aa3")},
            }
        };
        ...
        // getchaintxstats 17280 0000030285a2a68613656d384fbd96d2e18ba0387ce3191c137506fe34eb8aa3
        chainTxData = ChainTxData{
                1722801389, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1722801394, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x55f92d99fd247bf13e15b0e16b967da5259cdd4a7a6efad522a1d3b1542ae67b"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad6e1bdb9520da07dcc11fe960afcb5fb025679b015af2c2265aedec7acb815"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x55f92d99fd247bf13e15b0e16b967da5259cdd4a7a6efad522a1d3b1542ae67b")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7Uv8zNQyzgMTMMYBjUw869DJDmzw2djzbcrijyu56QiJkPVySkx
        vSporkAddresses = {"TJfi4NzxX3pPnAdwQotrSvJGhms7VKXfUK"};
        nMinSporkKeys = 1;
        ...
        // Regtest Atom addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest Atom script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest Atom BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Atom BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Atom BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
