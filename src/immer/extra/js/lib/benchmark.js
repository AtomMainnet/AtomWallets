...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loatom.
    var _ = context && context._ || require('loatom') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loatom methods to
     * make working with arrays, collections, and objects easier. The loatom
     * methods are:
     * [`each/forEach`](https://loatom.com/docs#forEach), [`forOwn`](https://loatom.com/docs#forOwn),
     * [`has`](https://loatom.com/docs#has), [`indexOf`](https://loatom.com/docs#indexOf),
     * [`map`](https://loatom.com/docs#map), and [`reduce`](https://loatom.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loatom methods to
     * make working with Suites easier. The wrapped loatom methods are:
     * [`each/forEach`](https://loatom.com/docs#forEach), [`indexOf`](https://loatom.com/docs#indexOf),
     * [`map`](https://loatom.com/docs#map), and [`reduce`](https://loatom.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loatom methods to Benchmark.
    ...
    // Add loatom methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loatom', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
