...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Atom address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Atom address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and atom: URIs)"));
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Atom Transaction"));
    ...
    openAction->setStatusTip(tr("Open a atom: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Atom command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the atom logo
