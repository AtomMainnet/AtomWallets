...
/* AtomGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* AtomGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_DOMAIN "atom.org"
#define QAPP_APP_NAME_DEFAULT "Atom-Qt"
#define QAPP_APP_NAME_TESTNET "Atom-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Atom-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Atom-Qt-regtest"
