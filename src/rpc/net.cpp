...
static UniValue addnode(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"addnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("addnode", "\"192.168.0.6:18762\" \"onetry\"")
    + HelpExampleRpc("addnode", "\"192.168.0.6:18762\", \"onetry\"")
        },
    }.Check(request);
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
    RPCHelpMan{"disconnectnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("disconnectnode", "\"192.168.0.6:18762\"")
    + HelpExampleCli("disconnectnode", "\"\" 1")
    + HelpExampleRpc("disconnectnode", "\"192.168.0.6:18762\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The atom server IP and port we're connected to"},
...
static UniValue addpeeraddress(const JSONRPCRequest& request)
{
    RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 18762")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 18762")
        },
    }.Check(request);
