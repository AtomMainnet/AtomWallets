...
official/supported Docker Images found at https://hub.docker.com/r/atompay/atomd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/atompay/atomd-develop/ when changing the above text**