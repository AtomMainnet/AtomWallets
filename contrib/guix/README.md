# Bootstrappable Atom Core Builds

This directory contains the files necessary to perform bootstrappable Atom
Core builds.
...
To build Atom Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/atom-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/atompay/guix.sigs).
...
[guix-docker]: https://github.com/AtomMainnet/tree/master/contrib/guix/Dockerfile
