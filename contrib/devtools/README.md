...
Setup
---------
Configuring the github-merge tool for the Atom Core repository is done in the following way:

    git config githubmerge.repository atompay/atom
...
A script to optimize png files in the atom
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_atom: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_atom: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_atom: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_atom: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
