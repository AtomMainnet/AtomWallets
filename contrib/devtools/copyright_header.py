...
Arguments:
    <base_directory> - The base directory of a Atom Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Atom Core developers'
...
Arguments:
    <base_directory> - The base directory of Atom Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Atom Core repository.
"""
