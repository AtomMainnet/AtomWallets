...
RCSUBDIR="test"
HOST1="https://github.com/AtomMainnet/releases/download/v"
HOST2="https://pasta.keybase.pub/Atom-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Atom Core binary release signing key installed?"
   fi
